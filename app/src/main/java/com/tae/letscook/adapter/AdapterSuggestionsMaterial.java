 ...
 */
public class AdapterSuggestionsMaterial extends RecyclerView.Adapter<AdapterSuggestionsMaterial.ViewHolder> {
    ...
    public AdapterSuggestionsMaterial(Context context, List<ItemRecipe> itemRecipes) {
...
//    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            categoryClickListener.onCategoryItemClick(v, getAdapterPosition(), suggestions.get(getAdapterPosition() - 1).getLabel(), Constants.ADAPTER_SUGGESTIONS_ID);
        }
